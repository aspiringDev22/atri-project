  ...
  "Home": {
    ...
    "Image2": {
      "custom": {
        ...
        "src": "/app-assets/Screenshot%20(75).png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox58": {
      "custom": {
        "text": "Design tips for desingers, that cover everything you need."
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox68": {
      "custom": {
        "text": "Logo design trend to avoid in 2021"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image30": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/work-removebg-preview.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image32": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/exp2-removebg-preview.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image33": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/exp3-removebg-preview.png"
      },
      "callbacks": {
        "onClick": [
          {
